...
public class library extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication6/lib sri.JPG"))); // NOI18N

        jLabel2.setText("Name:                 Mr.Srikanth Reddy");

        jLabel3.setText("Designation:      Librarian");

        jLabel4.setText("Availabilty:    In Library room on the left side of the entrance");

        jLabel5.setText("Time:            During lunch hours and from 10-3pm");

        jButton1.setText("lodge a complaint");
