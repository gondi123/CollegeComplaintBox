...
public class placements extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication6/nln1.jpg"))); // NOI18N

        jLabel2.setText("Name:       Dr NLN.Reddy");

        jLabel3.setText("Availability:    In the placement office above canteen");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new placements().setVisible(true);
            }
        });
    }
